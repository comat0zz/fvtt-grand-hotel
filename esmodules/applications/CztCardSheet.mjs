...
export default class CztCardSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
    /**
    ...
    static PARTS = {
        ...
        info: {
            template: `${SYSTEM.template_path}/sheets/items/card-tab-sheet.hbs`
        },
        notes: {
